...
/*
====================================================
WHATSAPP BUTTON – VERSIÓN INDUSTRIAL
- Negro estructural
- Acento amarillo
- Glow técnico sutil
- Coherente con marca
...
export default function WhatsAppButton() {
  ...
  const mensaje =
    "Hola, quiero solicitar información sobre sus servicios.";
  ...
  return (
    ...
    >
      {/* Glow técnico */}
      <div className="absolute inset-0 rounded-full border border-yellow-500 opacity-0 hover:opacity-100 blur-md transition duration-300" />

      {/* Ícono WhatsApp monocromático */}
      <svg
